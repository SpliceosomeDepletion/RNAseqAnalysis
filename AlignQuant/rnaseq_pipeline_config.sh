...
reference=/nfs/nas21.ethz.ch/nas/fs2102/biol_ibt_usr_s1/mfrank/Internship/PRPF8_rnaseq2019/data/Human_genome/Gencode_v29/GRCh38.primary_assembly.genome.fa

# Genome annotation File (full path)
annotation=/nfs/nas21.ethz.ch/nas/fs2102/biol_ibt_usr_s1/mfrank/Internship/PRPF8_rnaseq2019/data/Human_genome/Gencode_v29/gencode.v29.annotation.gtf
...
# STAR inputs
	...
	genomeDir=/nfs/nas21.ethz.ch/nas/fs2102/biol_ibt_usr_s1/mfrank/Internship/PRPF8_rnaseq2019/data/Human_genome/Gencode_v29/STAR_genome_index/
	...
	# Cufflinks-like strand field flag, needs to be set to intronMotif for unstranded reads, set to None otherwhise
...
# Cufflinks inputs
	...
	# Sets the memory(per core) that cufflinks can use
	cl_mem=1024
	# Specifies the library preparation. Choose: fr-unstranded (e.g. unstranded Illumina TruSeq), fr_firststrand (dUTP, NSR, NNSR) , etc.
