...
RUNSCRIPT=/nfs/nas21.ethz.ch/nas/fs2102/biol_ibt_usr_s1/mfrank/Internship/PRPF8_rnaseq2019/src/RNAseqAnalysis/rnaseq_pipeline.sh;
...
do
  ...
  #echo $R2;
  mkdir ${OUTDIR}/$NAME
  $RUNSCRIPT 1 0 $NAME ${OUTDIR}/$NAME $PARAMFILE ${DATADIR}/$R1 ${DATADIR}/$R2;
  #cd ..;
done
